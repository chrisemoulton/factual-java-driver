...
public class DemoCrosswalkBuenaVista {
  ...
  public static void main(String[] args) {
    ...
    // Get Facebook Crosswalk data for The Buena Vista Social club, using its
    // Foursquare ID
    System.out.println(factual.fetch(
        "places",
        new CrosswalkQuery().namespace("foursquare")
            .namespaceId("4ae4df6df964a520019f21e3").only("facebook"))
        .getJson());
  }
